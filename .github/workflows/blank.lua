...
local function initialize()
    ...
    local function femboyelliot()
        if player.Character.Name ~= "Elliot" then
                    Rayfield:Notify{Title = "Wrong Character", Content = "Oops, your current character isn't Elliot, this POSSIBLY can bug out, so untoggle unless you're on Elliot!!", Duration = 3}
                    return end
            for _, v in pairs(player.Character:GetChildren()) do
                if v:IsA("Shirt") then
                    v:Destroy()
                ...
                --
                shirt.ShirtTemplate = "http://www.roblox.com/asset/?id=6338125419"
                pants.PantsTemplate = "http://www.roblox.com/asset/?id=730003802"
                ...
                CharacterMesh.Parent = Enum.Body.Torso
                CharacterMesh.MeshId =  "rbxassetid://15740978124" 
                ...
                --
                --
                headbandmesh.MeshId = "http://www.roblox.com/asset/?id=14136513933"
                ...
                Players.PlayerAdded:Connect(function(plr)
	                ...
	                DefaultHumanoidDesc.Face = 7150603829
            ...
            playerinfo.PlayerIcon.Image = "http://www.roblox.com/asset/?id=121488301096085"
    ...
    local kaiguy = survivortab:CreateButton({
     ...
     local femboy = survivortab:CreateButton({
        Name = " Femboy Elliot Skin (testing)"
        callback = function() 
        femboyelliot()
        end, 
     }) 
